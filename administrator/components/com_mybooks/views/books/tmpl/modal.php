...
require_once JPATH_ROOT.'/components/com_mybooks/helpers/route.php';
...
$function = $jinput->get('function', 'selectBook');
$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn  = $this->escape($this->state->get('list.direction'));
?>

<form action="<?php echo JRoute::_('index.php?option=com_mybooks&view=books&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <fieldset class="filter clearfix">
    <div class="btn-toolbar">
      ...
      <div class="btn-group pull-left">
	      ...
	      title="<?php echo JText::_('COM_MYBOOKS_FILTER_SEARCH_DESC'); ?>" />
      </div>
      <div class="btn-group pull-left">
	...
	<?php echo JHtml::_('select.options', JHtml::_('category.options', 'com_mybooks', array('filter.language' => array('*', $this->state->get('filter.forcedLanguage')))), 'value', 'text', $this->state->get('filter.category_id'));?>
      </select>
      ...
      <select name="filter_category_id" class="input-medium" onchange="this.form.submit()">
	<option value=""><?php echo JText::_('JOPTION_SELECT_CATEGORY');?></option>
	<?php echo JHtml::_('select.options', JHtml::_('category.options', 'com_mybooks'), 'value', 'text', $this->state->get('filter.category_id'));?>
      </select>
      <select name="filter_tag" class="input-medium" onchange="this.form.submit()">
	<option value=""><?php echo JText::_('JOPTION_SELECT_TAG');?></option>
	<?php echo JHtml::_('select.options', JHtml::_('tag.options', 'com_mybooks'), 'value', 'text', $this->state->get('filter.tag'));?>
      </select>
  ...
  <table class="table table-striped table-condensed">
	...
	<th width="15%" class="nowrap hidden-phone">
		<?php echo JHtml::_('grid.sort', 'JDATE', 'b.created', $listDirn, $listOrder); ?>
	</th>
