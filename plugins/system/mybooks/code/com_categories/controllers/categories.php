...
class CategoriesControllerCategories extends JControllerAdmin
{
	...
	public function publish()
	{
	  ...
	  if(!empty($cid)) {
	    ...
	    if(($task == 'trash' || $task == 'archive') && !MybooksHelper::checkMainCategories($cid)) {
	      $this->setRedirect(JRoute::_('index.php?option=com_categories&view=categories&extension=com_mybooks', false));
	      return false;
	    }
	  }
